...
public class FlowableTest {
    ...
    public void init() {
        ProcessEngineConfiguration cfg = new StandaloneProcessEngineConfiguration()
                .setJdbcUrl("jdbc:mysql://bdm26827513.my3w.com:3306/bdm26827513_db?autoReconnect=true&useUnicode=true&characterEncoding=utf8&zeroDateTimeBehavior=convertToNull&useSSL=false")
                .setJdbcUsername("bdm26827513")
                .setJdbcPassword("ruoxue123")
